...
function login($login, $pass)
{
  ...
  // on fait une requête SQL qui vérifie que le login et le pass existe dans la table comptes
  ...
  if ($nb_ligne == 1) {
    ...
    //on stocke en SESSION les valeurs qui nous intéressent
...
function slide(){
    ...
    $slide.="</section>";
    $slide.="<section id='home' class='flex'>
